                            ...
                            html.Div([
                                ...
                                html.Div([
                                    ...
                                    html.Div([
                                        ...
                                        html.Span('The annual marginal increase of the RPS requirement, the current law requires 1%, however this could be increased in the future.'
                                        , className="tooltiptext")], className="tooltip", style={'padding-left':5}),        
                                    dcc.Input(id='annual_rps_inc_2023',value=1,type='number',step=0.01,style={'width':'100%'}, min=0.25)
                                        ],
                                    className='four columns',
                                ),
...
html.Div([
    ...
    html.Div([
        ...
        and you have planned for what years you will need to procure renewables. You can review your RPS plan by clicking the offline RPS calculator in the link below. 
        """)
    ],
    className='twelve columns'),

    html.A(
        "Download Offline RPS Calculator", 
